  ...
  "node_modules/apexcharts/dist/apexcharts.common.js"(exports, module) {
        ...
        value: function(t3) {
          ...
          if (g2.height = 2 * (l2 + d2) + "px", g2.width = 2 * (l2 + d2) + "px", g2.left = h2 + "px", g2.top = c2 + "px", s2.config.legend.markers.customHTML) g2.background = "transparent", g2.color = a2[i2], Array.isArray(s2.config.legend.markers.customHTML) ? s2.config.legend.markers.customHTML[i2] && (r2.innerHTML = s2.config.legend.markers.customHTML[i2]()) : r2.innerHTML = s2.config.legend.markers.customHTML();
            ...
            var u2 = new D(this.ctx).getMarkerConfig({
              ...
              pointFillColor: Array.isArray(s2.config.legend.markers.fillColors) ? a2[i2] : u2.pointFillColor,
              shape: n2
            }));
    ...
    var vt = function() {
      ...
      return r(t2, [{
        ...
        value: function(t3) {
          var e2 = t3.x, i2 = t3.y, a2 = t3.y1, s2 = t3.y2, r2 = t3.i, o2 = t3.j, n2 = t3.realIndex, l2 = t3.columnGroupIndex;
          t3.series;
          var h2, c2, d2 = t3.barHeight, g2 = t3.barWidth, u2 = t3.barXPosition, p2 = t3.barYPosition, f2 = t3.visibleSeries, x2 = t3.renderedPath, b2 = this.w, v2 = new m(this.barCtx.ctx), y2 = Array.isArray(this.barCtx.strokeWidth) ? this.barCtx.strokeWidth[n2] : this.barCtx.strokeWidth;
          b2.globals.isXNumeric && !b2.globals.isBarHorizontal ? (h2 = e2 + parseFloat(g2 * (f2 + 1)), c2 = i2 + parseFloat(d2 * (f2 + 1)) - y2) : (h2 = e2 + parseFloat(g2 * f2), c2 = i2 + parseFloat(d2 * f2));
          var w2, k2 = null, A2 = e2, S2 = i2, C2 = {}, L2 = b2.config.dataLabels, P2 = this.barCtx.barOptions.dataLabels, M2 = this.barCtx.barOptions.dataLabels.total;
          void 0 !== p2 && this.barCtx.isRangeBar && (c2 = p2, S2 = p2), void 0 !== u2 && this.barCtx.isVerticalGroupedRangeBar && (h2 = u2, A2 = u2);
          var I2 = L2.offsetX, T2 = L2.offsetY, z2 = {
            width: 0,
            height: 0
          };
          if (b2.config.dataLabels.enabled) {
            var X2 = b2.globals.series[r2][o2];
            z2 = v2.getTextRects(b2.globals.yLabelFormatters[0](X2), parseFloat(L2.style.fontSize));
          }
          var E2 = {
            x: e2,
            y: i2,
          ...
          return C2 = this.barCtx.isHorizontal ? this.calculateBarsDataLabelsPosition(E2) : this.calculateColumnsDataLabelsPosition(E2), x2.attr({
            cy: C2.bcy,
            cx: C2.bcx,
            j: o2,
            val: b2.globals.series[r2][o2],
            barHeight: d2,
            barWidth: g2
          }), w2 = this.drawCalculatedDataLabels({
            x: C2.dataLabelsX,
            y: C2.dataLabelsY,
            val: this.barCtx.isRangeBar ? [a2, s2] : b2.globals.series[r2][o2],
            i: n2,
            j: o2,
            barWidth: g2,
            barHeight: d2,
            textRects: z2,
            dataLabelsConfig: L2
          }), b2.config.chart.stacked && M2.enabled && (k2 = this.drawTotalDataLabels({
            x: C2.totalDataLabelsX,
            y: C2.totalDataLabelsY,
            barWidth: g2,
            barHeight: d2,
            realIndex: n2,
            textAnchor: C2.totalDataLabelsAnchor,
